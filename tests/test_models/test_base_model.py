...
class TestBaseModel(unittest.TestCase):
    ...
    def test_if_BaseModel_instance_has_id(self):
        """Checks if instance has an id assigned on init"""

        b = BaseModel()
        self.assertTrue(hasattr(b, "id"))

    def test_str_representation(self):
        """Checks if string rep is appropriate"""
    ...
    def test_updated_at_is_datetime(self):
        """Checks attribute 'updated_at' is a datetime object"""

        b = BaseModel()
        self.assertTrue(type(b.updated_at) is datetime)

    def test_two_models_different_created_at(self):
        """Checks attribute 'created_at' of 2 models are diff"""
    ...
    def test_to_dict_not_dunder_dict(self):
        """Checks if to_dict() is a dict object not equal to __dict__"""
